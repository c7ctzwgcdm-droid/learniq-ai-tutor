      ...
      "https://ai.gateway.lovable.dev/v1/chat/completions",
      {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: "system",
              content: "You are a quiz generator for students. Generate high-quality multiple choice questions.",
            },
            {
              role: "user",
              content: `Generate ${count} multiple choice questions about "${topic}" at ${difficulty} difficulty level.`,
            },
          ],
          tools: [
            {
